...
const Modal = ({
  ...
  useEffect(() => {
    const isOpen = uncontrol ? showModal : activeModal ?? false;
    if (isOpen) {
  ...
  }, [uncontrol, showModal, activeModal]);
          ...
          <Transition appear show={showModal} as={Fragment}>
            ...
            >
              ...
              <div className="fixed inset-0 overflow-hidden">
                <div
                  className={`flex min-h-full justify-center text-center p-6 overflow-y-auto ${
                ...
                >
                 ...
                 bg-white dark:bg-slate-800 text-left align-middle shadow-xl transition-alll flex flex-col ${className}`}
                    >
                      <div
                        className={`relative overflow-hidden py-4 px-5 text-white flex justify-between flex-shrink-0 ${themeClass}`}
                      >
                      ...
                      {footerContent && (
                        <div
                          className={`px-4 py-3 flex justify-end space-x-3 border-t border-slate-100 dark:border-slate-700 flex-shrink-0 ${
                            isMobile ? "pb-6" : ""
                          }`}
                        >
                          {footerContent}
