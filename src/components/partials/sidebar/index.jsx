...
const Sidebar = () => {
  ...
  const [showOldMenu, setShowOldMenu] = useState(false);

  const devMenuOld = () => {
    setShowOldMenu(!showOldMenu);
  };
  // semi dark option
  ...
  return (
    <div className={isSemiDark ? "dark" : ""}>
      <div
        className={`sidebar-wrapper bg-white dark:bg-slate-800 z-[9999]    ${
      ...
      >
        ...
        >
          <Navmenu menus={showOldMenu ? menuItems : menuItemsCustom} />
          {/* Тут был заяц  */}
          {/* {!collapsed && (
